...
COPY company_dim
FROM 'D:\Backup\Databases\Project_data_job_analysis\csv_files-20260208T121047Z-1-001\csv_files\company_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_dim
FROM 'D:\Backup\Databases\Project_data_job_analysis\csv_files-20260208T121047Z-1-001\csv_files\skills_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY job_postings_fact
FROM 'D:\Backup\Databases\Project_data_job_analysis\csv_files-20260208T121047Z-1-001\csv_files\job_postings_fact.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_job_dim
FROM 'D:\Backup\Databases\Project_data_job_analysis\csv_files-20260208T121047Z-1-001\csv_files\skills_job_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
